# pages/3_San_Agustin.py
# ======================================================
# Everwise Dashboard 2026 · Sede San Agustín
# ======================================================
...
require_login("San Agustín")

campus = CAMPUS["san_agustin"]

# Sidebar
render_sidebar(sede_name="San Agustín")
...
with tab1:
    estado_asistencia = estado_por_valor(91, 90, 80)
    ...
    with k1:
        kpi_card("Asistencia Promedio", "91%", "+1% vs mes anterior", estado=estado_asistencia)
    with k2:
...
with tab2:
    ...
    if not render_campus_dynamic_view("acad", sede_actual):
        ...
        st.info("**Aviso:** El enfoque prioritario se desplaza hacia la consolidación del dominio en Matemáticas en B3.")
...
with tab3:
    ...
    if not render_campus_dynamic_view("clima", sede_actual):
        ...
        st.info("**Lectura ejecutiva:** San Agustín mantiene un clima escolar favorable y alta asistencia.")
